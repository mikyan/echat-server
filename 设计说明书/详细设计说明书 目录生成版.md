...
* 5. [流程逻辑](#-1)
	...
	* 5.2. [各用例活动图](#-1)
		* 5.2.1. [注册登录](#-1)
		* 5.2.2. [添加好友（拉式，第一次迭代）](#-1)
		* 5.2.3. [接受好友请求（拉式，第一次迭代）](#-1)
		* 5.2.4. [添加好友（推式，第二次迭代）](#-1)
		* 5.2.5. [接受好友请求（推式，第二次迭代）](#-1)
		* 5.2.6. [与好友文字聊天](#-1)
		* 5.2.7. [与好友图片聊天](#-1)
		* 5.2.8. [与好友视频聊天（第二次迭代）](#-1)
		* 5.2.9. [修改个人信息](#-1)
* 6. [接口定义](#-1)
	* 6.1. [通用枚举类说明](#-1)
	* 6.2. [接口会使用的类说明](#-1)
		...
		* 6.2.2. [接口使用的统一响应类](#-1)
	* 6.3. [接口说明](#-1)
	* 6.4. [netty的handler说明](#nettyhandler)
		* 6.4.1. [ChatHandler](#ChatHandler)
		* 6.4.2. [HeartBeatHandler](#HeartBeatHandler)
* 7. [框架说明和代码设计(设计模式)](#-1)
	* 7.1. [框架的设计](#-1)
		* 7.1.1. [java反射机制(代理模式)](#java)
		* 7.1.2. [Spring](#Spring)
		* 7.1.3. [Netty](#Netty)
		* 7.1.4. [Mybatis](#Mybatis)
	* 7.2. [自己的设计](#-1)
		* 7.2.1. [单例模式](#-1)
		* 7.2.2. [拦截器](#-1)
		* 7.2.3. [抽象工厂模式结合策略模式](#-1)
* 8. [用户界面设计](#-1)
	* 8.1. [通讯格式](#-1)
		* 8.1.1. [用户界面设计](#-1)
		* 8.1.2. [首页](#-1)
...
###  6.2. <a name='-1'></a>接口会使用的类说明

####  6.2.1. <a name='-1'></a>接口使用的实体类说明
...
###  6.4. <a name='nettyhandler'></a>netty的handler说明

####  6.4.1. <a name='ChatHandler'></a>ChatHandler
...
####  7.1.4. <a name='Mybatis'></a>Mybatis
...
##  9. <a name='-1'></a>数据库系统设计

###  9.1. <a name='-1'></a>数据库逻辑结构
